...
func (*VarLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e, []int{0}
}
...
func (*FixedLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e, []int{1}
}
...
func (*FeatureConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e, []int{2}
}
...
func (*ExampleParserConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/example/example_parser_configuration.proto", fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e)
}

var fileDescriptor_example_parser_configuration_ca5cff5429f4ce4e = []byte{
