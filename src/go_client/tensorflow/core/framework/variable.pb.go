...
func (*VariableDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_8b7cdb55506f8a7e, []int{0}
}
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_8b7cdb55506f8a7e, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor_variable_8b7cdb55506f8a7e)
}

var fileDescriptor_variable_8b7cdb55506f8a7e = []byte{
