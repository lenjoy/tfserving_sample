...
func (*NodeDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_def_5fbb0e490b7a1157, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/node_def.proto", fileDescriptor_node_def_5fbb0e490b7a1157)
}

var fileDescriptor_node_def_5fbb0e490b7a1157 = []byte{
