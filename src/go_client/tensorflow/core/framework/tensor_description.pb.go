...
func (*TensorDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_description_8ff1abb34c0fadda, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor_tensor_description_8ff1abb34c0fadda)
}

var fileDescriptor_tensor_description_8ff1abb34c0fadda = []byte{
