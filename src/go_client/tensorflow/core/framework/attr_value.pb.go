...
func (*AttrValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_9e2bba3b3198f5bb, []int{0}
}
...
func (*AttrValue_ListValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_9e2bba3b3198f5bb, []int{0, 0}
}
...
func (*NameAttrList) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_9e2bba3b3198f5bb, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/attr_value.proto", fileDescriptor_attr_value_9e2bba3b3198f5bb)
}

var fileDescriptor_attr_value_9e2bba3b3198f5bb = []byte{
