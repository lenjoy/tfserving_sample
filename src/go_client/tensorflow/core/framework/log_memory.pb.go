...
func (*MemoryLogStep) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{0}
}
...
func (*MemoryLogTensorAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{1}
}
...
func (*MemoryLogTensorDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{2}
}
...
func (*MemoryLogTensorOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{3}
}
...
func (*MemoryLogRawAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{4}
}
...
func (*MemoryLogRawDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_6231c6e469314921, []int{5}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/log_memory.proto", fileDescriptor_log_memory_6231c6e469314921)
}

var fileDescriptor_log_memory_6231c6e469314921 = []byte{
