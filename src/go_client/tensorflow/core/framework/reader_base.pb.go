...
func (*ReaderBaseState) Descriptor() ([]byte, []int) {
	return fileDescriptor_reader_base_123f6c24db5e323e, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/reader_base.proto", fileDescriptor_reader_base_123f6c24db5e323e)
}

var fileDescriptor_reader_base_123f6c24db5e323e = []byte{
