...
func (*AllocationDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_allocation_description_dd13053ef6254bf3, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/allocation_description.proto", fileDescriptor_allocation_description_dd13053ef6254bf3)
}

var fileDescriptor_allocation_description_dd13053ef6254bf3 = []byte{
