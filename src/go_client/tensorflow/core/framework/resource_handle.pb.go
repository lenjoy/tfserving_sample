...
func (*ResourceHandleProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_handle_b47b0544d4ef2f11, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/resource_handle.proto", fileDescriptor_resource_handle_b47b0544d4ef2f11)
}

var fileDescriptor_resource_handle_b47b0544d4ef2f11 = []byte{
