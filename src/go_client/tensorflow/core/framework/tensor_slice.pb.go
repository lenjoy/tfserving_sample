...
func (*TensorSliceProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_slice_101c431789cba2a4, []int{0}
}
...
func (*TensorSliceProto_Extent) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_slice_101c431789cba2a4, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_slice.proto", fileDescriptor_tensor_slice_101c431789cba2a4)
}

var fileDescriptor_tensor_slice_101c431789cba2a4 = []byte{
