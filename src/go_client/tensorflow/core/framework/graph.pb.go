...
func (*GraphDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_53476598eb73d825, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/graph.proto", fileDescriptor_graph_53476598eb73d825)
}

var fileDescriptor_graph_53476598eb73d825 = []byte{
