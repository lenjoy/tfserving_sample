...
func (*TensorProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_734aa1ca6850aa6b, []int{0}
}
...
func (*VariantTensorDataProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_734aa1ca6850aa6b, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor.proto", fileDescriptor_tensor_734aa1ca6850aa6b)
}

var fileDescriptor_tensor_734aa1ca6850aa6b = []byte{
