...
func (*InterconnectLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_2fe395d49ea5292d, []int{0}
}
...
func (*LocalLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_2fe395d49ea5292d, []int{1}
}
...
func (*DeviceLocality) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_2fe395d49ea5292d, []int{2}
}
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_2fe395d49ea5292d, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/device_attributes.proto", fileDescriptor_device_attributes_2fe395d49ea5292d)
}

var fileDescriptor_device_attributes_2fe395d49ea5292d = []byte{
