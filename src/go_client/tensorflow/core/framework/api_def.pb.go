...
func (ApiDef_Visibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_def_48de4b16fa9b29b1, []int{0, 0}
}
...
func (*ApiDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_48de4b16fa9b29b1, []int{0}
}
...
func (*ApiDef_Arg) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_48de4b16fa9b29b1, []int{0, 1}
}
...
func (*ApiDef_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_48de4b16fa9b29b1, []int{0, 2}
}
...
func (*ApiDefs) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_48de4b16fa9b29b1, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/api_def.proto", fileDescriptor_api_def_48de4b16fa9b29b1)
}

var fileDescriptor_api_def_48de4b16fa9b29b1 = []byte{
