...
func (*IteratorStateMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_iterator_449ac692b5189bd9, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/iterator.proto", fileDescriptor_iterator_449ac692b5189bd9)
}

var fileDescriptor_iterator_449ac692b5189bd9 = []byte{
