...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_f8cebab9500c16ad, []int{0}
}
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_f8cebab9500c16ad, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor_tensor_shape_f8cebab9500c16ad)
}

var fileDescriptor_tensor_shape_f8cebab9500c16ad = []byte{
