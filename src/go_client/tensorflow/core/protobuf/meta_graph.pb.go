...
import framework "go_client/tensorflow/core/framework"
...
func (*MetaGraphDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{0}
}
...
func (*MetaGraphDef_MetaInfoDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{0, 0}
}
...
func (*CollectionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1}
}
...
func (*CollectionDef_NodeList) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1, 0}
}
...
func (*CollectionDef_BytesList) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1, 1}
}
...
func (*CollectionDef_Int64List) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1, 2}
}
...
func (*CollectionDef_FloatList) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1, 3}
}
...
func (*CollectionDef_AnyList) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{1, 4}
}
...
func (*TensorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{2}
}
...
func (*TensorInfo_CooSparse) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{2, 0}
}
...
func (*SignatureDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{3}
}
...
func (*AssetFileDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_graph_8adb8cd8c68a51b0, []int{4}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/meta_graph.proto", fileDescriptor_meta_graph_8adb8cd8c68a51b0)
}

var fileDescriptor_meta_graph_8adb8cd8c68a51b0 = []byte{
