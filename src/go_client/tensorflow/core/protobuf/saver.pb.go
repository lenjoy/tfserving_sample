...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_bf7aab48008c1bc3, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_bf7aab48008c1bc3, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_bf7aab48008c1bc3)
}

var fileDescriptor_saver_bf7aab48008c1bc3 = []byte{
