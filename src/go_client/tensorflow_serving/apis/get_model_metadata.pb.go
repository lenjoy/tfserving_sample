...
import protobuf "go_client/tensorflow/core/protobuf"
...
func (*SignatureDefMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_344e29ff79fb4764, []int{0}
}
...
func (*GetModelMetadataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_344e29ff79fb4764, []int{1}
}
...
func (*GetModelMetadataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_metadata_344e29ff79fb4764, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_metadata.proto", fileDescriptor_get_model_metadata_344e29ff79fb4764)
}

var fileDescriptor_get_model_metadata_344e29ff79fb4764 = []byte{
