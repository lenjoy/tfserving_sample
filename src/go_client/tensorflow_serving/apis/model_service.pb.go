...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_service.proto", fileDescriptor_model_service_086abd46f29ca721)
}

var fileDescriptor_model_service_086abd46f29ca721 = []byte{
