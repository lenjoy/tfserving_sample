...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/prediction_service.proto", fileDescriptor_prediction_service_a6cd984febc3d6f7)
}

var fileDescriptor_prediction_service_a6cd984febc3d6f7 = []byte{
