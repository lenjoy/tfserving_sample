...
func (*InferenceTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_d0ab2c1ba18d68ac, []int{0}
}
...
func (*InferenceResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_d0ab2c1ba18d68ac, []int{1}
}
...
func (*MultiInferenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_d0ab2c1ba18d68ac, []int{2}
}
...
func (*MultiInferenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_inference_d0ab2c1ba18d68ac, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/inference.proto", fileDescriptor_inference_d0ab2c1ba18d68ac)
}

var fileDescriptor_inference_d0ab2c1ba18d68ac = []byte{
