...
func (*Class) Descriptor() ([]byte, []int) {
	return fileDescriptor_classification_5d2503e921245ffb, []int{0}
}
...
func (*Classifications) Descriptor() ([]byte, []int) {
	return fileDescriptor_classification_5d2503e921245ffb, []int{1}
}
...
func (*ClassificationResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_classification_5d2503e921245ffb, []int{2}
}
...
func (*ClassificationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_classification_5d2503e921245ffb, []int{3}
}
...
func (*ClassificationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_classification_5d2503e921245ffb, []int{4}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/classification.proto", fileDescriptor_classification_5d2503e921245ffb)
}

var fileDescriptor_classification_5d2503e921245ffb = []byte{
