...
import fmt "fmt"
import math "math"
import config "go_client/tensorflow_serving/config"
import util "go_client/tensorflow_serving/util"
...
func (*ReloadConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_01da141c16db05b9, []int{0}
}
...
func (*ReloadConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_management_01da141c16db05b9, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/model_management.proto", fileDescriptor_model_management_01da141c16db05b9)
}

var fileDescriptor_model_management_01da141c16db05b9 = []byte{
