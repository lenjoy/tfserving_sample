...
func (*PredictRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_predict_51784a9e815ef9b7, []int{0}
}
...
func (*PredictResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_predict_51784a9e815ef9b7, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/predict.proto", fileDescriptor_predict_51784a9e815ef9b7)
}

var fileDescriptor_predict_51784a9e815ef9b7 = []byte{
