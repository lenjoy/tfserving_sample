...
import fmt "fmt"
import math "math"
import core "go_client/tensorflow/core/lib/core"
...
func (*StatusProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_status_2a950c2ca9620f44, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/util/status.proto", fileDescriptor_status_2a950c2ca9620f44)
}

var fileDescriptor_status_2a950c2ca9620f44 = []byte{
