...
func (*PlatformConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_platform_config_416976fe2bb52821, []int{0}
}
...
func (*PlatformConfigMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_platform_config_416976fe2bb52821, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/platform_config.proto", fileDescriptor_platform_config_416976fe2bb52821)
}

var fileDescriptor_platform_config_416976fe2bb52821 = []byte{
