...
func (*LogCollectorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_collector_config_ec8052c1a6792139, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/log_collector_config.proto", fileDescriptor_log_collector_config_ec8052c1a6792139)
}

var fileDescriptor_log_collector_config_ec8052c1a6792139 = []byte{
