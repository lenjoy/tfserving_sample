...
func (*SamplingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_07d1dca15c3e9c9a, []int{0}
}
...
func (*LoggingConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_logging_config_07d1dca15c3e9c9a, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/config/logging_config.proto", fileDescriptor_logging_config_07d1dca15c3e9c9a)
}

var fileDescriptor_logging_config_07d1dca15c3e9c9a = []byte{
