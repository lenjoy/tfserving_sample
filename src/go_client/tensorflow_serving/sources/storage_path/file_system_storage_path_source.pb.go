...
func (*FileSystemStoragePathSourceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0}
}
...
func (*FileSystemStoragePathSourceConfig_ServableVersionPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0, 0}
}
...
func (*FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0, 0, 0}
}
...
func (*FileSystemStoragePathSourceConfig_ServableVersionPolicy_All) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0, 0, 1}
}
...
func (*FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0, 0, 2}
}
...
func (*FileSystemStoragePathSourceConfig_ServableToMonitor) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_system_storage_path_source_d1e919add109e0a5, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/sources/storage_path/file_system_storage_path_source.proto", fileDescriptor_file_system_storage_path_source_d1e919add109e0a5)
}

var fileDescriptor_file_system_storage_path_source_d1e919add109e0a5 = []byte{
